...
unsigned char local_ip[] = { 192,168,1,11};   // IP address of WiShield
unsigned char gateway_ip[] = { 192,168,1,1};   // router or gateway IP address
unsigned char subnet_mask[] = { 255,255,255,0};   // subnet mask for the local network
const prog_char ssid[] PROGMEM = { "P880"};      // max 32 bytes
unsigned char security_type = 3;   // 0 - open; 1 - WEP; 2 - WPA; 3 - WPA2

// WPA/WPA2 passphrase
const prog_char security_passphrase[] PROGMEM = { "075508086"};   // max 64 characters

// WEP 64-bit keys
// sample HEX keys
prog_uchar wep_keys[] PROGMEM = { 
  0x07, 0x55, 0x08, 0x08, 0x60, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,   // Key 0
  ...
  if (strcmp(URL, "/") == false) //why is this not true?
   {
      ...
      WiServer.print("<body><font size=20><center>Please select the led state:<center>\n<center>");
      for (stateCounter = 0; stateCounter < 3; stateCounter++) //for each led
      {
        ...
        strcat(tmpStrCat, "</a><p>&nbsp;</p><p>&nbsp;</p> "); //we now have something in the range of <a href=?LED0>Led 0: Off</a>
